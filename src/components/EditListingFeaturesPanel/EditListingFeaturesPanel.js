...
const FEATURES_NAME = 'basketballSkills';
...
const EditListingFeaturesPanel = props => {
  ...
  const basketballSkills = publicData && publicData.basketballSkills;
  const initialValues = { basketballSkills };
  ...
  return (
    <div className={classes}>
      ...
      <EditListingFeaturesForm
        ...
        onSubmit={values => {
          const { basketballSkills = [] } = values;

          const updatedValues = {
            publicData: { basketballSkills },
          };
